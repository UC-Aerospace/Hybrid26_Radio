...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SX1262_BUSY_GPIO_Port, SX1262_BUSY_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SX1262_RESET_Pin SX1262_BUSY_Pin */
  GPIO_InitStruct.Pin = SX1262_RESET_Pin|SX1262_BUSY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
